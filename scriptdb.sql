...
create table
  region (
    ...
    region_nombre varchar(20) not null
...
create table
  Provincia (
    ...
    capital_provincia varchar(60),
    descripcion_provincia varchar(250),
    poblacion_provincia int,
    superficie_provincia decimal(10, 2),
    latitud_provincia decimal(10, 10),
    longitud_provincia decimal(10, 10),
    id_region int,
...
create table
  empleado (
    id int primary key auto_increment,
    emp_nombres varchar(70) not null,
    emp_apellidos varchar(70) not null,
    emp_cedula varchar(10) not null,
    emp_fec_nacimiento date,
    emp_correo varchar(150) not null,
    emp_obs_pers varchar(250),
    emp_foto LONGTEXT,
    emp_fec_ingreso date not null,
    emp_cargo varchar(50) not null,
    emp_departamento varchar(60) not null,
    emp_salario int not null,
    emp_jor_parcial enum ('Si', 'No') not null,
    emp_obs_lab varchar(250),
    emp_status enum ('vigente', 'retirado') not null,
    provPersona_id INT,
    provLaboral_id INT,
    FOREIGN KEY (provPersona_id) REFERENCES Provincia (id),
    FOREIGN KEY (provLaboral_id) REFERENCES Provincia (id)
  ) ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_spanish_ci;
...
personajes ilustres de la sociedad ecuatoriana',
    '569.42',
    '122.00',
    '-2.902222',
    '-
...
llama así en honor al Libertador Simón Bolívar.',
    '183 641',
    '3254.00',
    '-1.6',
    '-
...
VALUES
  (
    'Carchi',
    'Tulcán',
    'Carchi es una provincia ecuatoriana situada al norte del Ecuador en
...
VALUES
  (
    'Chimborazo',
    'Riobamba',
    'En esta provincia se encuentran varias de las cumbres más
elevadas del país, como el Carihuairazo, el Altar, Igualata, Sangay, entre otros, que en
algunos casos comparte con otras provincias.',
    '223586.00',
    '6487.00',
    '-1.666667',
    '-
...
VALUES
  (
    'Cotopaxi',
    'Latacunga',
    'La provincia toma el nombre del volcán más grande e importante
...
VALUES
  (
    'Esmeraldas',
    'Esmeraldas',
    'Provincia del Ecuador situada en su costa noroccidental,
...
VALUES
  (
    ...
    'P.
Baquerizo Moreno',
    'Es el mayor centro turístico del Ecuador, así como también una de las
...
conservar al máximo la flora y fauna de la región.',
    '5600.00',
    '8010.00',
    '-0.666667',
    ' -
...
VALUES
  (
    'Guayas',
    'Guayaquil',
    'Es el mayor centro comercial e industrial del Ecuador. Con sus
...
VALUES
  (
    'Imbabura',
    'Ibarra',
    'La provincia también es conocida por sus contrastes poblacionales
es así que la población está marcada por diferentes factores demográficos, además desde
siempre ha sido núcleo de artesanías y cultura.',
    '181722.00',
    '4599.00',
    '0.35',
    '-
...
Rios',
    'Babahoyo',
    'Los Ríos, oficialmente Provincia de Los Ríos, es una de las 24
...
provincias de Bolívar, Guayas y Santa Elena.',
    '778115.00',
    '6254.00',
    '-1.766669',
    '-
...
Santiago',
    'Macas',
    'Morona Santiago (nombre oficial Provincia de Morona Santiago) es una
...
Morona Santiago. Su capital es la ciudad de Puyo.',
    '83933.00',
    '29520.00',
    '-1.066667',
    '-
...
VALUES
  (
    'Pichincha',
    'Quito',
    'La Provincia de Pichincha es una de las 24 provincias que
...
VALUES
  (
    ...
    'Santa
Elena',
    'Santa Elena es una provincia de la costa de Ecuador creada el 7 de noviembre de
2007, la más reciente de las 24 actuales, con territorios que anterior a esa fecha
formaban parte de la provincia del Guayas, al oeste de ésta.',
    '308693.00',
    '3763.00',
    '-
2.2267',
...
Tsáchilas',
    'Santo Domingo',
    'La Provincia de Santo Domingo de los Tsáchilas es una de las
...
por las provincias de Cotopaxi, Chimborazo y Pastaza.',
    '504583.00',
    '3334.00',
    '-
1.233333',
...
Chimchipe',
    'Zamora',
    'Zamora Chinchipe es una provincia de Ecuador ubicada en el suroriente de la Amazonía ecuatoriana, que limita con la provincia de Morona Santiago al
